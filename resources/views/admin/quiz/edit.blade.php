<x-app-layout>
    ...
    <div
        ...
        <form class="bg-white w-full space-y-4" method="post" action="{{ route('quizzes.update', $quiz->id) }}"
            ...
            <div>
                <label class="block">Title
                    <input name="title" type="text" class="w-full mt-1 p-2 border rounded"
                        value="{{ $quiz->title }}" placeholder="Enter Title">
                        @if ($errors->has('title'))
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="option_one" type="text" class="w-full mt-1 p-2 border rounded"
                        placeholder="Enter Option One">{{ old('option_one', $quiz->option_one) }}</textarea>
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="option_two" type="text" class="w-full mt-1 p-2 border rounded"
                        placeholder="Enter Option Two">{{ old('option_two', $quiz->option_two) }}</textarea>
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="option_three" type="text" class="w-full mt-1 p-2 border rounded"
                        placeholder="Enter Option Three">{{ old('option_three', $quiz->option_three) }}</textarea>
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="option_four" type="text" class="w-full mt-1 p-2 border rounded"
                        placeholder="Enter Option Four">{{ old('option_four', $quiz->option_four) }}</textarea>
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="description" type="text" class="w-full mt-1 p-2 border rounded"
