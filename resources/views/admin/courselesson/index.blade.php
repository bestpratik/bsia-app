            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4 ">
                <div class="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                        <div>
                            <a href="{{ route('create.courselessons') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center gap-3">
                                            <div>
                                                @if ($row->downloadable_file)
                                                    <a href="{{ asset('uploads/' . $row->downloadable_file) }}"
                                 ...
                                 2.25 0 006 20.25z" />
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center">
                                            <a href="{{ route('edit.courselessons', $row->id) }}"
                                                class="ml-3 cursor-pointer hover:text-blue-500 dark:hover:text-blue-400">
                                            ...
                                            <form action="{{ route('coursemodules.toggleStatus', $row->id) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form action="{{ route('delete.courselessons', $row->id) }}" method="POST"
