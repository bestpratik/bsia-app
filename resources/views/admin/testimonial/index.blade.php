                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div>
                                                    <img src="{{ $row->image ? asset('uploads/' . $row->image) : asset('photo/default-banner.jpg') }}" alt="Testimonial Image"
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div>
                                                    <span class="text-theme-sm mb-0.5 block font-medium text-gray-700 ">
                                                        {!! \Illuminate\Support\Str::limit(strip_tags($row->profession), 30) !!}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
