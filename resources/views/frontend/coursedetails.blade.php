                 ...
                 <ol class="inline-flex items-center space-x-1 md:space-x-3">
                     ...
                     <li>
                         <div class="flex items-center">
                             ...
                             <a href="{{ route('courses') }}" class="text-sm font-medium text-gray-700 hover:text-brand-red">
                                 Courses
                             </a>
                         </div>
                     </li>
                     <li aria-current="page">
                         <div class="flex items-center">
                             <i class="fas fa-chevron-right text-gray-400 text-xs mx-2"></i>
                             <span class="text-sm font-medium text-brand-red">Infinite Astrology</span>
                         </div>
                     </li>
                 </ol>
             </nav>
                 ...
                 <div class="lg:col-span-2">
                     ...
                     <div
                         ...
                         <div class="relative">
                             <img src="{{asset ('photo/c2.jpg') }}" alt="Advance Numerology Mentorship Program"
                                 class="w-full h-64 md:h-80 object-cover" loading="lazy" decoding="async" />
                     ...
                     <div class="bg-white rounded-xl shadow-md p-6 md:p-8 mb-8 wow animate__animated animate__fadeInUp"
                         ...
                         <p class="text-gray-700">
                             Learn from Scratch: No prior astrology knowledge required.
                         </p>
                         <p class="text-gray-700">
                     ...
                     <div class="bg-white rounded-xl shadow-md p-6 md:p-8 mb-8 wow animate__animated animate__fadeInUp"
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                             <div class="flex items-start">
                                 ...
                                 <p class="text-gray-700">
                                     Master advanced numerological calculations
                                 </p>
                             </div>
                             <div class="flex items-start">
                                 <div
                             ...
                             <div class="bg-gray-50 p-4 flex justify-between items-center cursor-pointer">
                                 <div class="flex items-center">
                                     ...
                                     <h3 class="font-medium text-brand-dark">
                                         Module 1: Introduction to Vedic Astrology
                                     </h3>
                                 </div>
                             ...
                             <div class="p-4 border-t border-gray-200">
                                 <ul class="space-y-3">
                                     <li class="flex items-center text-gray-700">
                                         ...
                                         <span>History & Basics of Astrology</span>
                                         <span class="ml-auto text-gray-500 text-sm">30 min</span>
                                     </li>
                                     <li class="flex items-center text-gray-700">
                                         <i class="fas fa-play-circle text-brand-orange mr-3"></i>
                                         <span>Understanding Zodiac Signs</span>
                                         <span class="ml-auto text-gray-500 text-sm">40 min</span>
                                     </li>
                                     <li class="flex items-center text-gray-700">
                                         <i class="fas fa-file-alt text-brand-blue mr-3"></i>
                                         <span>Reference Chart & Symbols</span>
                         ...
                         <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                             ...
                             <div>
                                 ...
                                 <p class="text-brand-orange font-medium mb-3">
                                     Vedic Astrologer & Co-Founder, BSIA
                                 </p>
                                 <p class="text-gray-700 mb-4">
                                     Born and raised in a spiritually rooted family in Shyamnagar
                                     (North 24 Parganas), Sujit Pathak has over 20 years of
                                     experience in astrology, Vastu, palmistry, numerology, and
                                     medical astrology. Known for blending classical texts with
                                     modern consultation, he offers remedies like gemstones,
                                     yantras, and color guidance. Author of the Bengali
                                     numerology guide "Sankhyar Khela", Sujit is a trusted name
                                     in India and abroad.
                                 </p>
                     ...
                     <div>
                         <a href="{{ route('course.details') }}">
                             <div
                                 ...
                                 <img src="{{asset ('photo/c1.jpg') }}" alt="Basic Numerology Course"
                                 ...
                                 <div class="p-5">
                                     ...
                                     <p class="text-gray-600 text-sm mb-4">
                                         Learn Basics of Numerology from the renowned Numerologist
                                         Arun Pandit and step into the world of numbers.
                                     </p>
                                     <div class="flex justify-between items-center">
                                         <span class="text-brand-red font-bold">₹998</span>
                                         <a href="#"
