...
<style>
  ...
  .course-card { border-radius: 15px; overflow: hidden; box-shadow: 0px 8px 25px rgba(0, 0, 0, 0.08); background: #fff; height: 100%; }
  .course-card img { height: 350px; width: 100%; object-fit: cover; }
  .course-overlay { background: linear-gradient(to top, rgba(0, 0, 0, 0.75), transparent); }
  .form-card { background: #fff; border-radius: 15px; box-shadow: 0px 8px 25px rgba(0, 0, 0, 0.08); padding: 35px; }
  .form-title { font-weight: 700; font-size: 1.5rem; margin-bottom: 25px; color: #333; text-align: center; }
  .section-title { font-weight: 600; font-size: 1rem; margin-top: 20px; margin-bottom: 12px; color: #6b1d1d; border-left: 4px solid #b52a2a; padding-left: 10px; }
  .btn-submit { background: linear-gradient(135deg, #b52a2a, #911f1f); border: none; border-radius: 8px; padding: 12px; font-size: 1rem; font-weight: 600; color: #fff; transition: 0.3s; }
  .btn-submit:hover { background: linear-gradient(135deg, #911f1f, #6b1d1d); }
  .form-control, .form-select { border-radius: 8px; padding: 10px 12px; }
  label { font-weight: 500; margin-bottom: 6px; }
  textarea { resize: none; }
  .total-box { background: #fafafa; border-radius: 8px; padding: 12px 18px; margin-bottom: 20px; border: 1px solid #eee; }
  .total-box h5 { margin: 0; font-weight: 600; color: #6b1d1d; }
      ...
      <div class="course-card">
        <div class="position-relative">
          ...
          <div class="course-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-end">
            <div class="p-4">
              <span class="badge bg-danger mb-2">{{ $itemType === 'course' ? 'Mentorship Program' : 'E-Book' }}</span>
