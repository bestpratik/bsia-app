             ...
             <nav class="flex" aria-label="Breadcrumb">
                 <ol class="inline-flex items-center space-x-1 md:space-x-3">
                     ...
                     <li aria-current="page">
                         <div class="flex items-center">
                             <i class="fas fa-chevron-right text-gray-400 text-xs mx-2"></i>
                             <span class="text-sm font-medium text-brand-red">{{ $ebook->title }}</span>
                         </div>
                     </li>
                 </ol>
             </nav>
             ...
             <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                 ...
                 <div class="lg:col-span-2">
                     ...
                     <div
                         ...
                         <div class="relative">
                             <img src="{{ asset('uploads/' . $ebook->featured_image) }}" alt="{{ $ebook->title }}"
                     ...
                     <div
                         ...
                         <div class="p-6 border-b border-gray-100">
                             <div class="flex items-center justify-between mb-4">
                                 <span class="text-3xl font-bold text-brand-dark">₹{{ $ebook->price }}</span>
                             </div>
                             <div class="space-y-3">
                                 <a href="{{ route('purchase.form', ['type' => 'ebook', 'id' => $ebook->id]) }}">
                                     <button
                 ...
                 <div class="mt-12 md:mt-16 wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                         ...
                         @foreach ($relatedEbooks as $related)
                             <div>
                                 <a href="{{ route('ebook.details', ['slug' => $related->slug]) }}">
                                     <div
                                         ...
                                         <div class="p-5">
                                             ...
                                             <p class="text-gray-600 text-sm mb-4">
                                                 {!! Str::limit($related->description, 100) !!}</p>
                                             <div class="flex justify-between items-center">
                                                 <span
                                                     class="text-brand-red font-bold">₹{{ number_format($related->price) }}</span>
                                                 <a href="{{ route('ebook.details', ['slug' => $related->slug]) }}"
                                                     class="px-4 py-2 bg-brand-red text-white rounded-lg hover:bg-brand-dark transition-colors text-sm font-medium">View
                                                     Details</a>
                                             </div>
                                         </div>
                                     </div>
