     ...
     <div class="container mx-auto px-4 max-w-7xl">
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
             ...
             <div class="lg:col-span-2">
                 ...
                 <div
                     ...
                     <div class="relative">
                         <img src="{{ asset('uploads/' . $ebook->featured_image) }}"
                             alt="{{ $ebook->title }}" class="w-full h-64 md:h-80 object-cover"
         ...
         <div class="mt-12 md:mt-16 wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 ...
                 <div>
                     <a href="{{ route('ebook.details', ['id' => $related->id]) }}">
                         <div
                             ...
                             <div class="p-5">
                                 ...
                                 <div class="flex justify-between items-center">
                                     ...
                                     <a href="{{ route('ebook.details', ['id' => $related->id]) }}"
                                         class="px-4 py-2 bg-brand-red text-white rounded-lg hover:bg-brand-dark transition-colors text-sm font-medium">View Details</a>
                                 </div>
                             </div>
                         </div>
                     </a>
