    ...
    <div class="bg-gray-50 border-b border-gray-200 py-4">
        <div class="container mx-auto px-4 max-w-7xl">
            <nav class="flex items-center space-x-2 text-sm">
                <a href="/" class="text-gray-500 hover:text-brand-red transition-colors">
            ...
            <div class="wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                <div class="bg-white rounded-2xl shadow-2xl p-8 sm:p-10 border border-gray-100">
                    ...
                    <div class="text-center mb-8">
                        <!-- <div class="w-20 h-20 bg-gradient-to-br from-brand-red to-red-700 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email"
                                    class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-red focus:border-brand-red transition-all duration-300 font-roboto text-gray-900 placeholder-gray-500"
                    ...
                    <div class="text-center mt-8 pt-6 border-t border-gray-200">
                        <p class="font-roboto text-gray-600 text-sm">
                            ...
                            <a href="#" class="text-brand-red hover:text-red-700 font-medium transition-colors">
                                Sign up here
                            </a>
                        </p>
                    </div>
