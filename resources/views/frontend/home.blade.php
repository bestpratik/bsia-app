...
<div class="hero-slider relative !mb-0">
    ...
    <div class="slide relative h-[450px] flex items-center justify-center bg-cover bg-center"
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto text-white h-full flex flex-col justify-center">
    ...
    <div class="slide video-slide relative h-[450px] flex items-center justify-center">
        <div class="video-wrapper absolute inset-0 overflow-hidden">
            <iframe class="w-full h-full"
                data-src="https://www.youtube-nocookie.com/embed/iUtnZpzkbG8?mute=1&loop=1&playlist=iUtnZpzkbG8&modestbranding=1&rel=0&enablejsapi=1"
            ...
            <a href="{{ route('course.details', $row->slug) }}"
                ...
                <div class="p-4 lg:p-6">
                    <img src="{{ asset('uploads/' .  $row->featured_image) }}" alt="Infinite Astrology"
                        class="w-full h-48 lg:h-56 object-cover rounded-lg mb-4" loading="lazy" decoding="async" />
                    ...
                    <div class="flex items-baseline justify-center gap-3 mb-4">
                        <span class="font-roboto text-sm lg:text-base text-gray-400 line-through">₹{{ $row->mrp }}</span>
                        <span class="font-roboto font-bold text-xl lg:text-2xl text-black">₹{{ $row->sellable_price }}</span>
                    </div>
    ...
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div class="lg:w-1/2 wow animate__fadeInLeft">
                <img src="{{ asset('uploads/' .  $about->image) }}" alt="About BSIA"
                    class="w-full h-auto rounded-2xl shadow-2xl object-cover" loading="lazy" decoding="async" />
            </div>
...
<!-- Stats Section -->
<section class="relative w-full py-12 bg-cover bg-center" style="background-image: url('{{ asset('photo/background.jpg') }}');">
    <!-- Overlay -->
    ...
    <div class="relative z-10 container mx-auto px-4 max-w-7xl">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-4 lg:gap-8">
            ...
            <div class="flex items-center gap-3 border border-white rounded-lg p-4 md:p-5 transform transition-all duration-700 ease-out hover:scale-105 hover:bg-white/20 hover:backdrop-blur-lg hover:shadow-xl cursor-pointer wow animate__bounceIn"
                data-wow-delay="0.1s">
                <img src="{{ asset('photo/s1.png') }}" alt="Success icon" class="w-12 h-12 sm:w-12 sm:h-12 md:w-14 md:h-14"
            ...
            <div class="flex items-center gap-3 border border-white rounded-lg p-4 md:p-5 transform transition-all duration-700 ease-out hover:scale-105 hover:bg-white/20 hover:backdrop-blur-lg hover:shadow-xl cursor-pointer wow animate__bounceIn"
                data-wow-delay="0.3s">
                <img src="{{ asset('photo/iso.svg') }}" alt="ISO icon" class="w-12 h-12 sm:w-12 sm:h-12 md:w-14 md:h-14"
                    loading="lazy" decoding="async" />
                <div>
                    <h3 class="text-white font-playfair font-bold text-xl md:text-2xl">
                        ISO
                ...
                <div
                    ...
                    <div class="absolute -top-[65px] left-1/2 transform -translate-x-1/2">
                        <img src="{{ asset('uploads/' .  $test->image) }}" alt=""
                            class="w-24 h-24 rounded-full border-[5px] border-white shadow-xl" loading="lazy"
                            decoding="async" />
                    </div>
